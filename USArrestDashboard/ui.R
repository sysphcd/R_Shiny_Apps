...
dashboardPage(
  ...
  dashboardHeader(title="Exploring the 1973 US Arrests data with R & Shiny Dashboard", titleWidth = 650, 
                  ...
                  tags$li(class="dropdown",tags$a(href="https://www.linkedin.com/in/pinhsuan-chend/" ,icon("linkedin"), "My Profile", target="_blank")),
                  tags$li(class="dropdown",tags$a(href="https://github.com/sysphcd", icon("github"), "Source Code", target="_blank"))
  ),
